...
class HamburgerButton: UIButton {
    ...
    let outline: CGPath = {
        ...
        path.addCurve(to: CGPoint(x: 40, y: 27),
                      control1: CGPoint(x: 12.00, y: 27.00),
                      control2: CGPoint(x: 28.02, y: 27.00))
        path.addCurve(to: CGPoint(x: 27, y: 2),
                      control1: CGPoint(x: 55.92, y: 27.00),
                      control2: CGPoint(x: 50.47, y:  2.00))
        path.addCurve(to: CGPoint(x: 2, y: 27),
                      control1: CGPoint(x: 13.16, y:  2.00),
                      control2: CGPoint(x:  2.00, y: 13.16))
        path.addCurve(to: CGPoint(x: 27, y: 52),
                      control1: CGPoint(x: 2.00, y: 40.84),
                      control2: CGPoint(x: 13.16, y: 52.00))
        path.addCurve(to: CGPoint(x: 52, y: 27),
                      control1: CGPoint(x: 40.84, y: 52.00),
                      control2: CGPoint(x: 52.00, y: 40.84))
        path.addCurve(to: CGPoint(x: 27, y: 2),
                      control1: CGPoint(x: 52.00, y: 13.16),
    ...
    override init(frame: CGRect) {
        ...
        for layer in [self.top, self.middle, self.bottom] {
            ...
            guard let strokingPath = CGPath(__byStroking: path, transform: nil, lineWidth: 4, lineCap: .round, lineJoin: .miter, miterLimit: 4) else {
                return
            }
